...
```{r}
allmins |> ggplot(aes(x=min_dist, fill = type)) + geom_histogram(binwidth = 50) + ggtitle("All locations")
schoolmins |> ggplot(aes(x=min_dist)) + geom_histogram(binwidth = 50) + ggtitle("All schools")

srd_mins |> ggplot(aes(x=min_dist)) + geom_histogram(binwidth = 50) + ggtitle("Shops")

prd_mins |> ggplot(aes(x=min_dist)) + geom_histogram(binwidth = 50) + ggtitle("Public Schools")

ird_mins |> ggplot(aes(x=min_dist)) + geom_histogram(binwidth = 50) + ggtitle("Independent Schools")
```
