...
The histograms above show the relative distance of different notable types of locations to the nearest bikeshare station. The distance is measured in meters. The locations were chosen as possibly overlooked impacts/untapped potential for greater ridership. Science Daily also reported that a decrease in the distance that people need to travel to access bikeshare stations could potentially increase ridership by a significant amount. Combining these two ideas, placing bike stations closer to these locations could boost ridership greatly. People who need to go to the store to quickly grab an item or 2 and kids that can't rely on their parents for timely pickups would be the desired impact groups, though other situations may impact someone's usage of the bikeshare system closer to schools and stores.
